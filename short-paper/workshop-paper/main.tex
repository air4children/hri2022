...
\begin{abstract}
In this paper, we present preliminary work of a pilot workshop to promote diversity and inclusion in AI and Robogics to children of an range age between 6 to 12 year old.
...
In that way, we presented tools based on free and open-source software, open-source harware and software, open educational resouces as well as alternative education programs to promote diversity and inclusion of new technogies. 
We present the desing and the pilot of four lessons of the workshop including: (a) to introduce, (b) to teach fundamentals, (c) to link sensor and human body with robots and (d) to wrap up with a showcase presentation.
