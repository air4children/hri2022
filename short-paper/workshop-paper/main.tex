...
\todo[inline]{MX: we might like to add references f AIR and low-income countries to connect with next bits of Xicothzinco}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{MX: this section requires to be improved}
...
In that sense one good option is Otto Humanoid because of its affortablity with a cost of 200 EUROS a block diagram programing interface, the multiple sensors and actuators (servos and LCD matrix display) aligned with open-source software and hardare principles \cite{OttoDIY:2016}.
...
Wiley \etal in 2014 stated that one of the benefits of Open educational resources (OERs) is to make course development process quicker and easier but also highlitying the challenges of making OER material for peolpe easier to find making finatially self-sustainable programs among many other difficulties \cite{Wiley2014}.
...
\begin{figure}[htbp]
    % \centerline{\includegraphics[width=\linewidth]{figures/curriculum.png}}
    \centerline{\includegraphics[width=\linewidth]{curriculum-design/versions/drawing-v01.png}}
...
\begin{figure}[htbp]
    % \centerline{\includegraphics[width=\linewidth]{figures/workshop.png}}
