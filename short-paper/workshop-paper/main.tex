...
\subsection{Open educational resources as a tool to promote Diversity and Inclusion Workshops in air4children}
"Open Educational Resources (OER) are teaching and learning materials that are available without access fees and with licensing that affords innovation through OER-enabled pedagogy." \cite{Clinton-Lisell2021}.
...
\todo[inline]{MX: we might like to add an introduction here of AIR in low-income countries to connect with next bits of Xicothzinco}
