...
We however noted that each lessons was originally planned to be 90 minutes of lenght and we did not consider breaks nor the participant's energy levels to which in the second to four lesson a 15 minutes break was incorporated.
...
In this paper, we posed the challenges of promoting Diversity and Inclusion of "Artificial Intelligence and Robotics for Children" in developing countries with reources of open source hardware and software, inclusive learning and principles of Montessori education. 
