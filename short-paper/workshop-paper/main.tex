...
\begin{abstract}
In this paper, we present preliminary work from a pilot workshop that aimed to promote diversity and inclusion in Artificial Intelligence (AI) and Robotics to children of an range age between 6 to 12 year old in the context of developing countries.
We also pose the challenge of teaching AI and Robotics in developing countries where scarcity of funding and little specialised professionals are able to teach such subjects.
In that way, we present resources based on free and open-source software, open-source hardware and software, open educational resources, and alternative education programs to promote diversity and inclusion and to teach AI and Robotics for children. 
...
We finalise the paper with conclusions and challenges for future work.  
\end{abstract}
...
In that sense, our next challenge in our previous work \cite{montenegro2021air4children} was to organise workshops in the context of communities of developing country where little is known about the demographics, education levels and socio-economical variables.  
That said, this work is addressing such challenge in the town of Xicohtzinco, Tlaxcala M\'exico which has a total population of 14,197 (6762 males and 7435 females) based on The National Institute of Statistics and Geography (INEGI)'s census and 
In terms of the number of schools, Xicohtzinco has seven kinder garders (3 publich and 4 private), seven primaries (4 publich and 3 private), four secondaries (2 publich and 2 private) and one publich hight-school [add SEP-SIGED ref].
However, the census and the SEP-SIGED do not provide further informantion about tehcnological on subjects in AI and Robotics.
