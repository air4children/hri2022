...
\IEEEauthorblockN{
    %1\textsuperscript{st} 
    A. Badillo-Perez, D. Badillo-Perez, D. Coyotzi-Molina, D. Cruz, R. Montenegro, L. Vazquez, M. Xochicale
    }
\IEEEauthorblockA{
...
For the curriculum of the workshops, we are planning to improve the activities to be more engaging, diverse and inclusive and to provide further evidence on how alternative education programs (e.g. Montessori, Waldorf, Regio Emilia \cite{edwards2002}; and "synthesis program"  \cite{synthesis2022}) with new technologies migth lead to potential new avenues of inclusivity and diversity.
