...
% email address or ORCID}
% \and
% \IEEEauthorblockN{6\textsuperscript{th} Miguel Xochicale}
% \IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
% \textit{name of organization (of Aff.)}\\
% City, Country \\
% email address or ORCID}
...
% in order to promote diversity and inclusion on teaching AI and Robotics for children.
...
The resources to reproduce this work are available at \url{https://github.com/air4children/hri2022}.
\end{abstract}
...
\begin{figure}[t]
    ...
    %\centerline{\includegraphics[width=\linewidth]{curriculum-design/versions/drawing-v04.png}}  %%GITHUB
    \centerline{\includegraphics[width=\linewidth]{drawing-v04.png}}  %%ARXIV
...
\begin{figure}[tbp]
    ...
    %\centerline{\includegraphics[width=\linewidth]{piloting-workshops/versions/drawing-v00.png}} %%GITHUB
    \centerline{\includegraphics[width=\linewidth]{drawing-v00.png}} %%ARXIV
    \caption{
